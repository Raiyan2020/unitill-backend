...
/**
 * Profile-level reports: "Report this user" from a listing/profile page
 * (no conversation involved) and in-chat "report this person" both land
 * here (type=user on the chat_reports table) — kept separate from
 * ChatReportsPage, which covers reported conversations (type=chat).
 */
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h2 className="text-2xl font-semibold text-[#2f2b3d] dark:text-[#d7d8ea]">{t.userReports}</h2>
